...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0002_user_city_user_home_or_flat_user_house_or_block_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_key', models.CharField(blank=True, max_length=150, null=True, verbose_name='Сессия анонимного пользователя')),
                ('first_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='Имя пользователя')),
                ('email', models.CharField(blank=True, max_length=150, null=True, verbose_name='Почта пользователя')),
